<template>
  <div class="container" style="width: 100%; height: 100%">
    ...
    >
      <div class="CompliantNum" style="width: 50%; height: 100%"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    BarChart() {
      var CompliantNum = document.getElementsByClassName("CompliantNum");
      for (var i = 0; i < CompliantNum.length; i++) {
        var myChart = echarts.init(CompliantNum[i]);
