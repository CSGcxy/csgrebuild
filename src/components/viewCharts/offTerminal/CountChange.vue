    ...
    return {
      ...
      CountChangeChartOption:{
        ...
        xAxis: {
          ...
          // },
          // data: ["8:00", "8:10", "8:20", "8:30", "8:40", "8:50", "9:00","9:10", "9:20", "9:30", "9:40", "9:50", "10:00", "10:10","10:20", "10:30", "10:40", "10:50", "11:00", "11:10", "11:20","11:30", "11:40", "11:50", "12:00", "12:10", "12:20", "12:30"]
          data:[]
        },
        yAxis: {
          type: 'value',
          scale:true, // 使坐标不从0开始,自适应确定y轴起始坐标
          axisLine: {
            lineStyle: {
              type: 'solid',
              color: '#F8F8FF',//左边线的颜色
